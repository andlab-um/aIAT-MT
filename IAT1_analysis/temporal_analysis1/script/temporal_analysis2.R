...
##113,110,101: exclued
mt_ev2 <- mt_subset(mt_ev2,subjID!=113&subjID!=110&subjID!=101)
...
av_tn_trajectories <- mt_aggregate_per_subject(mt_3,
                                               use="tn_trajectories", use2_variables="condition2",
                                               subject_id="subjID")
av_tn_trajectories2<-subset(av_tn_trajectories,subjID!=110&subjID!=113&subjID!=101)
# Paired t-tests on coordinates
xpos_t_tests_ev2 <- 
